...
class AURAMoodEngine {
        ...
        this.themes = {
            ...
            cyberpink: {
                ...
                colors: {
                    ...
                    secondary: '#FF6EC7',
                    accent: '#FFB3F6',
                    background: 'linear-gradient(135deg, #2B133D 0%, #FF2EC4 60%, #FFB3F6 100%)',
                    text: '#fff0fa',
                    glow: '#FF2EC4'
                },
                particles: '#FF2EC4',
                solarSystem: {
                    sun: '#FF2EC4',
                    planets: ['#FF6EC7', '#FFB3F6', '#FF2EC4', '#2B133D']
                }
            },
            electricblue: {
                name: 'Electric Blue',
                colors: {
                    ...
                    secondary: '#002147', // Deep navy
                    accent: '#FF2E2E', // Red accent
                    background: 'linear-gradient(135deg, #002147 0%, #00BFFF 60%, #ffffff 100%)',
                    text: '#ffffff',
                    glow: '#00BFFF'
                },
                particles: '#00BFFF',
                solarSystem: {
                    sun: '#00BFFF',
                    planets: ['#002147', '#FF2E2E', '#ffffff', '#00BFFF']
                }
            }
        };
    ...
    applyTheme(themeName) {
        ...
        // Lightning effect for cyberpink and electricblue
        this.removeLightningEffect();
        this.removeGalaxyParticles();
        if (themeName === 'cyberpink') {
            this.addLightningEffect('pink');
        } else if (themeName === 'electricblue') {
            this.addLightningEffect('blue');
    ...
    addLightningEffect(type = 'pink') {
        if (document.getElementById('cyber-lightning')) return;
        const lightning = document.createElement('div');
        lightning.id = 'cyber-lightning';
        ...
        let flashClass = 'lightning-flash';
        if (type === 'blue') flashClass += ' lightning-blue';
        lightning.innerHTML = `<div class="${flashClass}"></div>`;
        document.body.appendChild(lightning);
    }
    removeLightningEffect() {
        const lightning = document.getElementById('cyber-lightning');
        if (lightning) lightning.remove();
    }
    addGalaxyParticles() {
        if (document.getElementById('galaxy-particles')) return;
        const galaxy = document.createElement('div');
        galaxy.id = 'galaxy-particles';
        ...
        for (let i = 0; i < 120; i++) {
            ...
            html += `<div class='galaxy-star' style='left:${x}vw;top:${y}vh;width:${size}px;height:${size}px;opacity:${opacity}'></div>`;
        }
        // Add a few nebula dots
        for (let i = 0; i < 8; i++) {
            ...
            html += `<div class='galaxy-nebula' style='left:${x}vw;top:${y}vh;width:${size}px;height:${size}px;background:${color}'></div>`;
        }
        galaxy.innerHTML = html;
        document.body.appendChild(galaxy);
    }
    removeGalaxyParticles() {
